  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* debug marker */}
        {/*debugCoords ? (
          <Marker coordinate={debugCoords} opacity={1} title='test title' description='test description' icon={4} />
        ) : null*/}

      </MapView>

      {(isFetchingData || !cellUserData) &&
      ...
      {/* debug tekstit karttanäkymän alla*/}
      {/*<Text>{debugText}</Text>*/}
